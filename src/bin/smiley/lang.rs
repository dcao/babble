...
use babble::{ast_node::{Arity, AstNode}, learn::LearnedLibrary, lift_lib::LiftLib, teachable::{BindingExpr, DeBruijnIndex, Teachable}};
...
lazy_static! {
    ...
    pub(crate) static ref LIFT_LIB_REWRITES: &'static [Rewrite<AstNode<Smiley>, ()>] =
        vec![LiftLib::rewrite("lift_compose", Smiley::Compose)].leak();
...
pub(crate) fn run_single(runner: Runner<AstNode<Smiley>, ()>) {
